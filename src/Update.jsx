...
const Update = () => {
    ...
    function handleSubmit(event) {
        ...
        // axios
        axios.put('http://localhost:8081/update/' + id, { firstname, lastname, male, female, dateofbirth, email, password, confirmpassword })
            .then(res => {
                console.log(res);
                navigate(`/student`);
        ...
        <div className='bg-green-500 w-screen h-screen flex justify-center items-center'>
            <div className='bg-white p-5 rounded-md w-[50vw]'>
                ...
                <form onSubmit={handleSubmit}>
                    <h2 className='text-3xl font-bold'>Update Student</h2>
                    <div className='mb-2'>
                    ...
                    <button className='px-8 py-4 bg-blue-500 w-full'>Update</button>
